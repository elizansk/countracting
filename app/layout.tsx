            ...
            <header className="sticky top-0 z-40 bg-white/90 border-b border-cyan-100 shadow-sm backdrop-blur">
              <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-4 px-4 py-4 sm:px-6">
                ...
                <nav className="flex flex-wrap items-center gap-2 text-sm text-slate-700">
                  <Link href="/types" className="rounded-md px-2 py-1 hover:bg-cyan-50 hover:text-cyan-800">Схемы</Link>
                  <Link href="/safety-tips" className="rounded-md px-2 py-1 hover:bg-cyan-50 hover:text-cyan-800">Памятки</Link>
                  <Link href="/resources" className="rounded-md px-2 py-1 hover:bg-cyan-50 hover:text-cyan-800">Куда обращаться</Link>
                  <Link href="/analytics" className="rounded-md px-2 py-1 hover:bg-cyan-50 hover:text-cyan-800">Аналитика</Link>
